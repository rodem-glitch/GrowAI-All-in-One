...
export const metadata: Metadata = {
  title: "CMS - GrowAI",
  description: "CMS (Content Management System) - Centralized content lifecycle management",
};
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="max-w-lg w-full text-center">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-indigo-100 mb-6">
          <span className="text-3xl font-black text-indigo-600">CMS</span>
        </div>
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Content Management System</h1>
        <p className="text-gray-500 mb-8">
          Centralized content lifecycle management with version control, tagging, and multi-tenant organization.
        </p>
