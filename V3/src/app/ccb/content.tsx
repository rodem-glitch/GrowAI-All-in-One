...
import { MessageCircle, Bot, Languages, Brain, BarChart3, Headphones } from "lucide-react";
  ...
  return (
    <SolutionPage
      ...
      features={[
        ...
        { icon: Brain, title: "감정 분석", desc: "고객의 감정 상태를 실시간으로 분석하여 응대 톤을 자동 조정합니다." },
      ...
      screenshots={[
        { title: "대화 인터페이스", desc: "자연스러운 대화형 챗봇 인터페이스입니다.", gradient: "from-cyan-100 to-sky-50" },
        { title: "관리자 콘솔", desc: "실시간 대화 모니터링과 에스컬레이션을 관리합니다.", gradient: "from-violet-100 to-purple-50" },
        { title: "분석 리포트", desc: "고객 만족도와 응답 성과를 시각화합니다.", gradient: "from-emerald-100 to-teal-50" },
      ]}
      aiFeatures={[
