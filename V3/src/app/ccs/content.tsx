...
import { Code2, Terminal, Bug, GitBranch, Shield, Rocket } from "lucide-react";
  ...
  return (
    <SolutionPage
      ...
      features={[
        ...
        { icon: Rocket, title: "CI/CD 자동화", desc: "테스트, 빌드, 배포 파이프라인을 자동으로 구성합니다." },
        { icon: Code2, title: "35+ 슬래시 명령", desc: "/review, /ship, /qa 등 전문가 수준의 자동화 명령을 제공합니다." },
      ]}
      screenshots={[
        { title: "코드 에디터", desc: "AI가 실시간으로 코드를 추천하고 완성합니다.", gradient: "from-indigo-100 to-blue-50" },
        { title: "리뷰 패널", desc: "자동 코드 리뷰 결과를 확인합니다.", gradient: "from-green-100 to-emerald-50" },
        { title: "보안 스캔 리포트", desc: "보안 취약점 스캔 결과를 시각화합니다.", gradient: "from-red-100 to-pink-50" },
      ]}
      aiFeatures={[
